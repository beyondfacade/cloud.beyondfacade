...
| 사람 판단이 필요한 것 | 평가셋 완화 질문 11건 재판정(외부 md) — 그 외 판정 완료(confirmed 169, fp16 Hit@5 1.00·MRR 0.95, §4-4) |
...
- **평가셋 확장(9/24 저녁, v0.37.0)** — funding 110 + news 40 추가 → **200건**(candidate 150, 시트 51~200번).
  ...
  **9/24 밤 결정 2건 실행(v0.37.1)**: ① 뉴스 다중 정답 — 40건 중 29건에 같은 사건 기사를 relevant_ids로 묶음
  ...
  현재 **confirmed 169 / rejected 20 / candidate 11**, 본지표 fp16 Hit@5 1.000·MRR 0.945 / ollama 1.000·0.941.

...
## 2. 에이전트 루프 — `apps/agent` BC (계획상 BE v0.20.0 → **실구현 BE v0.21.0**)
...
## 3. 프론트 전환 (계획상 FE v0.13.0 → **실구현 FE v0.14.0**)
...
| 2 | agent BC + 도구 7종 + SSE + usage 로깅 (gemma3 배선) | BE v0.20.0 → **실측 v0.21.0** |
| 3 | 프론트 AI 탭 실 API 전환 | FE v0.13.0 → **실측 v0.14.0** |
